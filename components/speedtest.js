...
export default {
  data: () => ({
    _serverList: [], //when using multiple points of test, this is a list of test points
    _selectedServer: null, //when using multiple points of test, this is the selected server
    _settings: {}, //settings for the speedtest worker
    _state: 0, //0=adding settings, 1=adding servers, 2=server selection done, 3=test running, 4=done
  }),
  methods: {
    /**
